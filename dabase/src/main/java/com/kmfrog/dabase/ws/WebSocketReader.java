...
import com.kmfrog.dabase.util.Utf8Validator;
        ...
        try {
            ...
            do {
                ...
                if (len > 0) {
                    ...
                    if (DEBUG) DLog.d(TAG, "run() : ConnectionLost");
            ...
            if (DEBUG) DLog.d(TAG, "run() : WebSocketException (" + e.toString() + ")");
            ...
            if (DEBUG) DLog.d(TAG, "run() : SocketException (" + e.toString() + ")");
            ...
            if (DEBUG) DLog.d(TAG, "run() : Exception (" + e.toString() + ")");
