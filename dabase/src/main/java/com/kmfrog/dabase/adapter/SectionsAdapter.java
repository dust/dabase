/*
 * Copyright (C) 2012 Mobs and Geeks Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file
...
/**
 * A very simple adapter that adds sections to adapters written for {@link android.widget.ListView}s. <br />
...
public abstract class SectionsAdapter<T> extends BaseAdapter {
    ...
    /**
     * Constructs a {@linkplain com.kmfrog.dabase.adapter.SectionsAdapter}.
     ...
     */
    public SectionsAdapter(Context context, BaseAdapter listAdapter, int sectionTitleTextViewId, Sectionizer<T> sectionizer) {
        if(context == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch(getItemViewType(position)) {
            case VIEW_TYPE_SECTION_HEADER:
                if(view == null) {
                    view=newInstanceSectionHeader(mContext);// View.inflate(mContext, mSectionHeaderLayoutId, null);
