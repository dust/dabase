 ...
 * or more contributor license agreements. See the NOTICE file distributed with this work for additional information regarding
 * copyright ownership. The ASF licenses this file to you under the Apache License, Version 2.0 (the "License"); you may not use
...
public class StringBody extends AbstractContentBody {
     ...
     * @since 4.1
     * 
     * @deprecated (4.3) use {@link org.apache.http.entity.mime.content.StringBody#StringBody(String, ContentType)} or {@link MultipartEntityBuilder}
     */
    @Deprecated
    ...
    /**
     * Create a StringBody from the specified text. The mime type is set to "text/plain". The {@linkplain Consts#ASCII ASCII}
     * charset is used.
     * 
     * @param text
     *        to be used for the body, not {@code null}
    ...
    public StringBody(final String text) throws UnsupportedEncodingException {
        this(text, "text/plain", Charset.forName("US-ASCII"));
    }
    ...
    public StringBody(final String text, final ContentType contentType) {
        ...
        final String csname=charset != null ? charset.name() : Charset.forName("US-ASCII").name();
        try {
    ...
    public Reader getReader() {
        ...
        return new InputStreamReader(new ByteArrayInputStream(this.content), charset != null ? charset
